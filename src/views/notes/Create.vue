                    ...
                    <div class="card-body">
                        <form action="#" method="post" @submit.prevent="store">
                            ...
                            <div class="form-group">
                                ...
                                <select v-model="form.subject_id" id="subject" class="form-select">
                                    <option v-for="aaa in subjects" :key="aaa.id" :value="aaa.id">
                                        {{ aaa.name }}
                                    </option>
                                </select>
...
export default {
    ...
    methods: {
        ...
        async store() {
            this.loading = true
            try {
                let response = await axios.post("/api/notes", this.form);
