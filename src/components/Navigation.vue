<template>
     <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
          <div class="container">
               <router-link class="navbar-brand" exact to="/">Navbar</router-link>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                         ...
                         <li class="nav-item dropdown">
                              ...
                              <ul class="dropdown-menu">
                                   <li>
                                        <router-link class="dropdown-item" :to="{ name: 'notes.create' }">New Note
                                        </router-link>
                                   </li>
                                   <li>
                                        <router-link class="dropdown-item" :to="{ name: 'notes.table' }">Table Of Note
                                        </router-link>
                                   </li>
                              </ul>
                         </li>
